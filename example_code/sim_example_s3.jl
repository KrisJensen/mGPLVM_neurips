"""
example simulation on the 3-sphere
"""
...
manifold = "3-sphere"
fit_manifold = "3-sphere" #manifold to fit
println("\n\n", " fitting ", fit_manifold, " to data generated from ", manifold)

N, T, mind, m, nmax, minH = 300, 600, 30, 100, 600, 300
...
if length(Lfit) == 1
    save("results/texample"*fit_manifold*".jld", "learned", θs, "true", true_params, "Lfit", Lfit, "argsx", argsx)
end
